    ...
    <div name = "contact" className='w-full h-screen bg-gradient-to-b from-black to-gray-800 text-white'>
        <div className='flex flex-col justify-center max-w-screen-lg p-4 mx-auto h-full'>
            ...
            <div className='flex justify-center items-center'>
                <form action='https://getform.io/f/433a90fd-32a5-4a22-aade-a1eaa2c2c2a4' method='POST' className='flex flex-col w-full md:w-1/2'>
                    <input type='text' name = "name" placeholder='Ener your name' className='p-2 bg-transparent border-2 rounded-md text-white focus:outline-none' />
                    <input type='text' name = "email" placeholder='Ener your email' className='my-4 p-2 bg-transparent border-2 rounded-md text-white focus:outline-none' />
